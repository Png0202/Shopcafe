    ...
    <head>
        ...
        <style>
            ...
            .filter-btn.btn-outline-custom.active:hover {
    ...
    <body>
                ...
                <div class="row justify-content-center mb-4">
                    <div class="col-md-6 position-relative">
                        <div class="input-group">
                            <span class="input-group-text bg-white border-end-0 text-warning" style="border-radius: 50px 0 0 50px; border-color: #d35400;">
                                <i class="fa-solid fa-magnifying-glass"></i>
                            </span>
                            <input type="text" class="form-control border-start-0 ps-0 py-2" 
                                placeholder="Tìm kiếm món ăn..." 
                                style="border-radius: 0 50px 50px 0; border-color: #d35400; box-shadow: none;"
        ...
        <script>
            ...
            function searchProduct(keyword) {
                // Reset bộ lọc về "Tất cả" khi tìm kiếm
                filterButtons.forEach(btn => btn.classList.remove('active'));
                ...
                searchTimeout = setTimeout(() => {
                    ...
                    fetch('${pageContext.request.contextPath}/menu?action=live_search&keyword=' + encodeURIComponent(keyword))
                        .then(res => res.text())
                        .then(html => {
